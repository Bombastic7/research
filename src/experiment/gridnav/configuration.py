...
DOMS = [
		{"name" : "base", "class" : gridnav_blocked_stack_merge(1000, 1000, True, True, 2, 2, 2, 1000), "abt": True},
		{"name" : "abtstack", "class" : gridnav_blocked(1000, 1000, True, True, True), "abt": False},
